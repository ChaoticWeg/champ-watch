...
// return info for multiple champs at once, selected by ids (array of ints)
var getChampsByID = exports.getChampsByID = function (ids, callback) {
	var statement = prepareStatement(
		'database#getChampsByID',
		QUERIES.getChampsByID,
		[ ids ]
	);
